        ...
        <div class="container">
            ...
            <form action="" method="POST" class="order" >
                    ...
                    <div class="food-menu-img">
                        ...
                        <?php
                            ...
                            else
                            {
                                //image available
                                ?>
                                <img src="<?php echo SITEURL;?>images/food/<?php echo $image_name;?>" alt="image here" class="img-responsive img-curve">
                ...
                <fieldset>
                    ...
                    <input type="tel" name="contact" placeholder="Mobile" class="input-responsive" required>
